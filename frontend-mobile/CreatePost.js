...
class CreatePost extends React.Component {
  ...
  render() {
    return (
      ...
      <TextInput onChangeText={newText => this.setState({userId: newText})} placeholder='UserId'/>
      <TextInput onChangeText={newText => this.setState({title: newText})} placeholder='Title'/>
      <TextInput onChangeText={newText => this.setState({body: newText})} placeholder="Body of the post"/>
